...
print_next_steps() {
    ...
    echo -e "     ${GREEN}./tools/linux_dashboard_start.sh${NC}"
    echo ""
    echo -e "     Or with tmux (recommended):"
    echo -e "     ${GREEN}./tools/linux_dashboard_start.sh --tmux${NC}"
    echo ""
    ...
    echo -e "  ${WHITE}3. Configure Drones:${NC}"
    echo ""
    echo -e "     Update drone config to point to this GCS IP"
    echo -e "     See: ${CYAN}docs/guides/drone-configuration.md${NC}"
    echo ""
